        ...
        body: Theme(
          ...
          child: Stepper(
            ...
            controlsBuilder: (BuildContext context,ControlsDetails controlsDetails){
                   return Padding(
                     ...
                     child: Row(
                       ...
                       children: [
                         ElevatedButton(onPressed: controlsDetails.onStepCancel,
            ...
            steps: [
              ...
              Step(
                  state: controller.selectedList.isNotEmpty ? StepState.complete: StepState.indexed,
                  isActive: currentStep>=2,
                  title: Text("Category"),
                  content: Column(
                   children:[
                     Obx(()=> controller.selectedList.value.length==0
                         ? Container(
                       height: 300,
